...
OUT_FILE = "task3_surface_elevation_upstream.png"
...
ax.set_title("Task 3: Surface Elevation Upstream of Cylinder (x=3m), U_current=0.2m/s")
...
print(f"Min: {eta_up.min():.4f}, Max: {eta_up.max():.4f}")
