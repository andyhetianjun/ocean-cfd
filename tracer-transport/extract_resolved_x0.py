...
OUT_DIR = "velocity_resolved_x0"
BOUNDS = ((0.0, 290.0), (15.0, 115.0), (-20.0, 20.0))
SHAPE = (1160, 400, 84)
WORKERS = 24
N_PROCS = 256
MAX_TIMESTEPS = 200
...
def main():
    ...
    todo = [t for t in times if (399 <= float(t) <= 595) and not os.path.exists(os.path.join(OUT_DIR, f"vel_{t}.npz"))]
