...
TASK3_DIR = "cases/task3_current_nocylinder/postProcessing/sampleSurface"
TASK4_DIR = "cases/task4_cylinder_current/postProcessing/sampleSurface"
OUT_DIR = "results/diff_frames_t3_t4"
